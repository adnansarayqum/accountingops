...
export function buildDemoData(today: IsoDate): PracticeData {
  ...
  comm({
    ...
    body: 'Hi Raj, we still need your bank statements and stock valuation for the accounts. Deadline is in 14 days. Reply here or email us. — Northgate Accountants',
    sentAt: ago(17, 12, 10),
    sentByUserId: 'u_michael',
    reminderStage: 'Email + WhatsApp (14 days)',
    documentsRequested: ['Bank statements', 'Stock valuation'],
  ...
  comm({
    ...
    channel: 'sms',
    recipient: '07700 900740',
    body: 'Hi Raj, urgent: the accounts deadline is in 3 days and we still need your bank statements and stock valuation. Please send today. — Northgate Accountants',
    sentAt: ago(6, 9, 30),
    sentByUserId: 'u_michael',
  ...
  comm({
    ...
    body: 'Hi Steve, thanks for the sales invoices, bank statements and card terminal statements. We\'re still waiting for your purchase invoices and fuel receipts for the VAT return. The deadline is in 10 days. — Michael, Northgate Accountants',
    sentAt: ago(5, 15, 20),
    sentByUserId: 'u_michael',
  ...
  comm({
    ...
    body: 'Hi Yusuf, thanks for the bank statements and payroll records. We still need your sales invoices, purchase invoices and till reports for the accounts. No rush yet, but sending them when you get a moment keeps everything on track. — Adnan, Northgate Accountants',
    sentAt: ago(14, 10, 0),
    sentByUserId: 'u_adnan',
  ...
  comm({
    ...
    body: 'Hi Sarah, thanks for the income summary. We\'re still waiting for your expense summary, bank interest and pension contributions for your tax return. No rush yet — the deadline is a few months away. — Priya, Northgate Accountants',
    sentAt: ago(12, 13, 0),
  ...
  return {
    practice: { id: PRACTICE_ID, name: 'Northgate Accountants', timezone: 'Europe/London' },
    users: DEMO_USERS,
    clients,
    contacts,
    identifiers,
